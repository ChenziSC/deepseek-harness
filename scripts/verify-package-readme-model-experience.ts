...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/knowledge': { kind: 'indirect', reason: 'The service interface delegates model rendering to knowledge Consumers.' },
  'packages/experimental/knowledge-local': { kind: 'indirect', reason: 'The local provider delegates model rendering to knowledge Consumers.' },
