...
| `ctx.knowledge` | `seam` | `knowledge` | `knowledge-local` | `tool-knowledge` | - | The provider returns ranked source fragments; the tool owns query limits, model-visible evidence, and call-local citations. |
